    ...
    <div class="d-inline-block d-xl-none ml-md-0 mr-auto py-3" style="position: relative; top: 3px;"><a href="#" class="site-menu-toggle js-menu-toggle text-black"><span class="icon-menu h3"></span></a></div>
        ...
        <div class="container">
            ...
            <?php if($_SESSION['admin']=='1'): ?>
                ...
                <div class="col-sm-9">
                <?php if($_SESSION['username']=='aryaraj132'): ?>
                    <div class="intern">
                        <h1>Change Password</h1>
                        <div class="box1">

                            <center>
                                <form method="POST" action="password.php"><br>
                                ...
                                <?php if($flag==1):?>
                                    ...
                                    <input type="password" placeholder="Confirm Password" name="passwordCnf" required><br><br>
                                    <button type="submit" name='change-pswd'>Change Password</button><br><br>
                                </form>
                            </center>
                        </div>
                    </div>
