                ...
                <div class="col-sm-9">
                    <div class="intern">
                        ...
                        <div class="box1">
                            ...
                            <center>
                                <form method="POST" action="edit_intern.php"><br>
                                    <input type="text" name="name" value="<?php echo $name ?>" placeholder="Full Name" required><br><br>
                                    <input type="text" name="f_name" value="<?php echo $f_name ?>" placeholder="Father's Name" required><br><br>
                                    <input type="text" name="college_name" value="<?php echo $college ?>" placeholder="College Name" required><br><br>
                                    <input type="text" name="branch" value="<?php echo $branch ?>" placeholder="Branch" required><br><br>
                                    <input type="tel" name="mob_no" value="<?php echo $mobile ?>" placeholder="Phone No." required><br><br>
                                    <input type="email" name="email" value="<?php echo $email ?>" placeholder="Email" required><br><br>
                                    <input type="text" name="ref_no" value="<?php echo $ref ?>" placeholder="Ref. No." required><br><br>
                                    <input type="text" name="tech" value="<?php echo $tech ?>" placeholder="Technology" required><br><br>
                                    ...
                                    <input type="submit" name="intern-edit" value="Edit" id="submitt">
