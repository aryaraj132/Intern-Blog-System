    ...
    <div class="site-wrap">
        ...
        <header class="site-navbar py-4 bg-white js-sticky-header site-navbar-target" role="banner">
            ...
            <div class="container">
                ...
                <li><a href="ManageBlog.php" class="nav-link">ManageBlog</a></li>
        ...
        <div class="row mt" style="margin: 100px 0 ;">
            <div class="col-lg-12">
                <div class="form-panel">
                    <?php if (isset($_SESSION['id'])) : ?>
                        <h2>Add Post</h2>
                        <form action="blog.php" method="POST" class="form" enctype="multipart/form-data">
                            <?php include(ROOT_PATH . "/php/formError.php"); ?>
                            <input type="text" class="form-input" name="title" placeholder="Title" value="<?php echo $title ?>" autofocus>

                            <textarea class="form-input" name="body" id="body" placeholder="Body"><?php echo $body ?></textarea>
                            <br />
                            <label>Add Image</label>
                            <input type="file" class="form-input" name="image">

                            <button class="btn btn-post" href="#" style="display: block;" type="submit" name="btn-post"> Add Post </button>
                        </form>
                    <?php else : ?>
