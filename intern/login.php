...
<form class="form" action="login.php" method="post">
		        ...
		        <div class="form-container">
		            <input type="text" class="form-input" value="<?php echo $username; ?>" placeholder="User ID" name="username" autofocus />
                    <input type="password" class="form-input" placeholder="Password" name="password">
                    <?php include(ROOT_PATH . "/php/formError.php"); ?>
		            <button class="btn btn-login" href="#" type="submit" name="btn-login"> SUBMIT </button>
		            <hr>
		        </div>
</form>	  	
</div>
